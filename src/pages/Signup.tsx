...
import { Wallet, ShieldCheck, Mail, Lock, User } from 'lucide-react';
    ...
    <div className="flex min-h-screen flex-col justify-center bg-slate-50 py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-slate-600">
          ...
          <Link to="/login" className="font-semibold text-brand-green hover:text-emerald-700">
            Sign in
          </Link>
        </p>
      </div>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
        <div className="bg-white px-6 py-12 shadow-xl shadow-slate-200 sm:rounded-3xl sm:px-12 border border-slate-100">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="name" className="block text-sm font-medium leading-6 text-brand-navy">
                Full Name
              </label>
          ...
          <div className="mt-10">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm font-medium leading-6">
                <span className="bg-white px-6 text-slate-500">Fast & Free</span>
              </div>
            </div>
